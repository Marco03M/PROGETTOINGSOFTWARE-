...
class Aerodinamica(Reparto):
    def __init__(self, nome="Aerodinamica", dipendenti_Anteriore=50, dipendenti_Posteriore=50, budget_Anteriore=35000000, budget_Posteriore=3500000):
       super().__init__()
       self.nome = nome
...
class PowerUnit(Reparto):
    def __init__(self, nome="Power Unit", dipendenti_MGUH=50, dipendenti_MGUK=50, budget_MGUK=35000000, budget_MGUH=35000000):
        super().__init__()
        self.nome = nome
